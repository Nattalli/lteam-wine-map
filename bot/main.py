...
def game_over(update: Update, context: CallbackContext, user_id: int):
    ...
    if points == 0:
        result_text = (
            ...
            "його можна придбати: http://127.0.0.1:8000/"
        )
    elif 1 <= points <= 2:
        result_text = (
        ...
        result_text = (
            ...
            "партнерів за посиланням: http://127.0.0.1:8000/😉 А ще, даємо "
            "Вам особисту знижку 10% на це вино. Ось Ваш промокод: PSIJD 🤫"
        )
        ...
        result_text = (
            ...
            "промокоду: PKDOS, який діє у всіх магазинах-партнерах. Щоб "
